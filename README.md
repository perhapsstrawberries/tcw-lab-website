...
- The Worker source is tracked at `workers/tcw-member-gate.js`. Deploy it to the existing `tcw-member-gate` Worker after changing the Cloudflare member gate UI or auth flow.
