...
function template({ route, title, body, sidebar = "", description = "" }) {
  ...
  const iconLinks = `<link rel="icon" type="image/png" sizes="512x512" href="/assets/icons/tcw-logo-20260731p.png?v=20260731p">`;
  return `<!doctype html>
...
<head>
  ...
  <link rel="stylesheet" href="${base}assets/css/styles.css?v=20260813b">
  <script src="${base}assets/js/site.js?v=20260813b" defer></script>
</head>
<body class="${classes}">
