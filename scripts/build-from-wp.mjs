...
<head>
  ...
  <link rel="icon" type="image/png" href="${base}assets/icons/tcw-circle-favicon-20260714.png">
  <link rel="shortcut icon" type="image/png" href="${base}assets/icons/tcw-circle-favicon-20260714.png">
  <link rel="apple-touch-icon" href="${base}assets/icons/tcw-circle-touch-20260714.png">
